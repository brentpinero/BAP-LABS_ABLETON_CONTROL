...
class AbletonConnection:
    ...
    def send_command(self, command_type: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        is_modifying_command = command_type in [
            ...
            "duplicate_clip_to_arrangement", "create_arrangement_clip",
...
# =============================================================================
# ARRANGEMENT VIEW TOOLS (Extended for Live 10+/12+)
# =============================================================================
...
def duplicate_clip_to_arrangement(
    ...
    """
    Duplicate a session view clip to the arrangement view at a specified position.

    Parameters:
    - track_index: The index of the track containing the clip
    - clip_index: The index of the clip slot in session view
...
def create_arrangement_clip(
    ...
    """
    Create a new MIDI clip directly in the arrangement view (Live 12+ only).

    Parameters:
    - track_index: The index of the MIDI track to create the clip in
    - start_time: Start time in beats for the clip
...
def add_notes_to_arrangement_clip(
    ...
    Parameters:
    - track_index: The index of the track containing the clip
    - clip_index: The index of the clip in arrangement_clips (not session view)
